...
import com.microservice.stateful_auth_api.core.dto.TokenData;
...
public class TokenService {
    ...
    private static final Long ONE_DAY_IN_SECONDS = 8600L;
    ...
    public TokenData getTokenData(String token) {
        ...
        try {
            ...
            throw new AuthenticationException("Error extracting the authenticated user: "+accessToken);
        }
    }
